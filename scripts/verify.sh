...
check "P6.5 model.provider=anthropic"    "hermes config get model.provider 2>/dev/null | grep -i anthropic"
check "P6.5 model.default=opus-4-7"      "hermes config get model.default 2>/dev/null | grep opus"
